...
int main() {
  ...
  cout << "\n\nTester oppgave A - Finner maxnivaaet for oddetalls bladnode:\n";
    traverserOppgA(gRoot);
  cout << "Hoyeste nivaa for oddetalls terminalnode er: " << gMaxHOB << '\n';


    cout << "\n\nTester oppgave B - Gjor om til binaert soketre:\n";
   ...
   cout << "Binaert soketre, traversert inorder (dvs. alfabetisk utskrift):\n";
